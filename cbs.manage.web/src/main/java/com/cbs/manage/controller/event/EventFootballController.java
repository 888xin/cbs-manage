...
// */
//@Controller
//@RequestMapping("/event/football")
//public class EventFootballController {
//
//    private static final Logger LOG = LoggerFactory.getLogger(EventFootballController.class);
//
//    // 跳转到今日足球页面
//    @RequestMapping("/show")
//    public String show() {
//        return "event/event_fb";
//    }
//
...
//            ret = CbsContestlApiUtil.getInstance().getContestFbFirstInfo(date);
//        } else {
//            ret = CbsContestlApiUtil.getInstance().getContestFbInfo(date, fullFlag);
//        }
//        if (ret != null) {
...
//            return outMap;
//        }
//        JSONObject ret = CbsContestlApiUtil.getInstance().getContestFbOddsInfo(contestId, oddsType, hasContest);
//        if (ret != null) {
//            int code = ret.optInt("code");
//            if (code == 200) {
...
//        Map<String, Object> outMap = new HashMap<String, Object>();
//        JSONObject ret = CbsContestlApiUtil.getInstance().getAbContestFbInfo(startId, limit);
//        if (ret != null) {
//            int code = ret.optInt("code");
//            if (code == 200) {
//                ContestListResponse contestListResponse = null;
...
//                ContestConstants.ContestType.FOOTBALL, limit);
//        if (ret != null) {
//            int code = ret.optInt("code");
//            if (code == 200) {
//                ContestListResponse contestListResponse = null;
...
//        if (contestId != null) {
//            // 单个
//            ret = CbsContestlApiUtil.getInstance().addSettle(contestId, ContestConstants.ContestType.FOOTBALL, true);
...
//        Map<String, Object> outMap = new HashMap<String, Object>();
//        JSONObject ret = CbsContestlApiUtil.getInstance().settleContest(contestId, ContestConstants.ContestType.FOOTBALL);
//        if (ret != null) {
//            int code = ret.optInt("code");
//            if (code != 200) {
//                outMap.put("msg", ret.optString("msg"));
...
//        Map<String, Object> outMap = new HashMap<String, Object>();
//        JSONObject ret = CbsContestlApiUtil.getInstance().getContestOddsFbInfo(oddsId, type, limit, isFive, byOrder);
//        if (ret != null) {
//            int code = ret.optInt("code");
//            if (code == 200) {
...
//        Map<String, Object> outMap = new HashMap<String, Object>();
//        JSONObject ret = CbsContestlApiUtil.getInstance()
//                .updateOpOdds(oddsOpResponse, ContestConstants.ContestType.FOOTBALL);
//        if (ret != null) {
//            int code = ret.optInt("code");
//            if (code != 200) {
//                outMap.put("msg", ret.optString("msg"));
...
//        JSONObject ret = CbsContestlApiUtil.getInstance()
//                .updateJcOdds(oddsJcResponse, ContestConstants.ContestType.FOOTBALL);
//        if (ret != null) {
//            int code = ret.optInt("code");
//            if (code != 200) {
//                outMap.put("msg", ret.optString("msg"));
...
//        Map<String, Object> outMap = new HashMap<>();
//        JSONObject ret = CbsContestlApiUtil.getInstance()
//                .updateSizeOdds(oddsSizeResponse, ContestConstants.ContestType.FOOTBALL);
//        if (ret != null) {
//            int code = ret.optInt("code");
//            if (code != 200) {
//                outMap.put("msg", ret.optString("msg"));
...
//                ContestConstants.ContestType.FOOTBALL);
//        if (ret != null) {
//            int code = ret.optInt("code");
//            if (code != 200) {
//                outMap.put("msg", ret.optString("msg"));
...
//        Map<String, Object> outMap = new HashMap<String, Object>();
//
//        JSONObject ret = CbsContestlApiUtil.getInstance().searchContestFbInfo(key, startTime, limit);
//        if (ret != null) {
//            int code = ret.optInt("code");
//            if (code == 200) {
//                ContestListResponse contestListResponse = null;
