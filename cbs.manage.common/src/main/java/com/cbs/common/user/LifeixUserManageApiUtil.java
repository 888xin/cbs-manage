...
//import com.lifeix.cbs.api.common.util.CbsUserConstants.ImageBucket;
...
//
//public class LifeixUserManageApiUtil {
//
//    private LifeixUserManageApiUtil() {
...
//	}
//
//	private static final LifeixUserManageApiUtil INSTANCE = new LifeixUserManageApiUtil();
//    }
//
//    public static LifeixUserManageApiUtil getInstance() {
...
//	    return register(auth_type, auth_key, 0, user_name, password, gender2, user_head, rand_code, machineCode, client,
//		    market, country, ipaddress, true);
//	} else {
//	    throw new L99NetworkException(ret.optString("code"), ret.optString("msg"));
//	}
//    }
