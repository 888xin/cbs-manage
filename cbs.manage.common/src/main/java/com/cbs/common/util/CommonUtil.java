...
public class CommonUtil {
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(CommonUtil.class);
    ...
    public static boolean filterManageIPs(String ipaddress) {
        String[] manageIps = {"192\\.168\\.(\\d+)\\.(\\d+)","127\\.0\\.0\\.1"};
        // String[] manageIps = { "192\\.168\\.(\\d+)\\.(\\d+)",
        // "127\\.(\\d+)\\.(\\d+)\\.(\\d+)" };
