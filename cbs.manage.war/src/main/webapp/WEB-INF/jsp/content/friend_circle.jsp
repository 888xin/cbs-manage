				...
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="table-header">猜友圈列表</div>
							<div class="table-responsive">
								<table id="frontpages_content_table"
                                                ...
                                                <div class="widget-main">
                                                    ...
                                                    <%--<fieldset>--%>
                                                        <%--<div class="grid2">--%>
                                                            ...
                                                            <%--<input type="text" id="modal_contest_id" placeholder="请输入赛事Id" />--%>
                                                        <%--</div>--%>
                                                        <%--<div class="grid2">--%>
                                                            <%--<label class="green bigger-150">赛事类型：&nbsp;&nbsp;</label>--%>
                                                            <%--<select id="modal_contest_type">--%>
