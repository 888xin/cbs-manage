...
<link rel="stylesheet"
	href="${appName}/public/css/cbs-manage/cbs_users.css" />
</head>
<body class="skin-3">
						...
						<div class="col-xs-12">
							...
							<h4 class="pink">
								<span class="input-icon"> <input type="text"
									placeholder="支持龙号、手机号、姓名搜索" class="nav-search-input"
									id="search_user" autocomplete="off" name="searchKey"
									style="width: 230px;" /> <i class="icon-search nav-search-icon"></i>
								</span> <i class="icon-hand-right icon-animated-hand-pointer blue"></i>
								<a href="#" id="search_user_modal" role="button" class="green">
									查找用户 </a>
							</h4>
							...
							<table id="user_table"
								...
								<thead>
									<tr>
										...
										<th class="center">投注统计信息</th>
										<th class="center">龙币</th>
										<th class="center">可用龙筹卷</th>
										<th class="center">增加龙币</th>
										<th class="center">扣除龙币</th>
										<th class="center">个人统计</th>
										<th class="hidden">userid</th>
										<th class="hidden">username</th>
										<th class="hidden">longno</th>
										<th class="center">发送消息提醒</th>
									</tr>
								</thead>
								<tbody>
								</tbody>
								...
								<div class="modal-dialog" style="width: 800px;">
									<div class="modal-content">
													...
													<form class="form-group">
														...
														<div class="profile-info-row">
															...
															<div class="profile-info-value">
																<input type="text" id="amount_money" name="amount_money"
																	value="0" />
															</div>
														</div>
										...
										<div class="modal-footer no-margin-top">
											...
											<button id="modal_money_edit_button"
								...
								<div class="modal-dialog" style="width: 800px;">
									<div class="modal-content">
												...
												<div class="widget-main">
													...
													<form class="form-group">
														...
														<div class="profile-info-row">
															...
															<div class="profile-info-value">
																<input type="text" id="amount_money_deduct"
																	name="amount_money" value="0" />
															</div>
														</div>
										...
										<div class="modal-footer no-margin-top">
											...
											<button id="modal_money_deduct_button"
												class="btn btn-sm btn-info pull-right" data-dismiss="modal">
												<i class="icon-check"></i> 确认提交
											</button>
										</div>
							...
							<div id="modal_coupon_show" class="modal fade" tabindex="-1">
								<div class="modal-dialog" style="width: 800px;">
									<div class="modal-content">
										<div class="widget-box">
											<div class="widget-header">
												...
												<div class="widget-main">
													...
													<form class="form-group">
														...
														<div class="profile-info-row">
															...
															<div class="profile-info-value" id="user_id_coupon"></div>
														</div>
														...
														<div class="profile-info-row">
															...
															<div class="profile-info-value" id="long_no_coupon"></div>
														</div>
														...
														<div class="profile-info-row">
															...
															<div class="profile-info-value" id="name_coupon"></div>
														</div>
														...
														<div class="profile-info-row">
															...
															<div class="profile-info-value" id="coupon_list"></div>
														</div>
							...
							<div id="modal_prompt" class="modal fade" tabindex="-1">
								<div class="modal-dialog" style="width: 800px;">
									<div class="modal-content">
										<div class="widget-box">
											<div class="widget-header">
												...
												<div class="widget-main">
													...
													<form class="form-group">
														...
														<div class="profile-info-row">
															...
															<div class="profile-info-value" id="user_id_prompt"></div>
														</div>
														...
														<div class="profile-info-row">
															...
															<div class="profile-info-value" id="long_no_prompt"></div>
														</div>
														...
														<div class="profile-info-row">
															...
															<div class="profile-info-value" id="name_prompt"></div>
														</div>
														
														<div class="profile-info-row">
	                                                        <div class="profile-info-name"><i>消息提醒内容</i></div>
	                                                        <div class="profile-info-value"><textarea  rows="3" cols="20" maxLength="70" id="prompt_info" name="prompt_info"></textarea></div>
                                                    	</div>
