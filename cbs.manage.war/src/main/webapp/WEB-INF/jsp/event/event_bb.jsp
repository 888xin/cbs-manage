            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <input id="date_picker_bb" type="text" />
                            ...
                            <div class="col-xs-12">
                                <h3 class="row header smaller lighter blue">
                                                <span class="col-sm-6">
                                                    ...
                                                    <span id="bb_table_head_title">一级赛事列表</span>
                                                    <span id="toolbar_info" class="grey smaller-80">(赛事总计：<b id="bb_num_i" class="red">0</b> 场)</span>
                                                </span><!-- /span -->
                                                <span class="col-sm-6">
                                                    <label class="inline">
                                                    ...
                                                    <label class="pull-right inline">
                                                        <button data-toggle="dropdown" class="btn btn-sm dropdown-toggle">
                                                            <i id="bb_dropdown_type">赛事类型</i>
                                                            <i class="icon-angle-down icon-on-right"></i>
                                                        </button>
                                                        <ul class="dropdown-menu dropdown-default">
                                                            <li>
                                                                <a id="bb_dropdown_first" href="#">一级赛事</a>
                                                            </li>
                                                            <li>
                                                                <a id="bb_dropdown_important" href="#">重要赛事</a>
                                                            </li>
                                                            <li>
                                                                <a id="bb_dropdown_all" href="#">全部赛事</a>
                                                            </li>
                                                            <li>
                                                                <a id="bb_dropdown_no_start" href="#">未开始</a>
                                                            </li>
                                                            <li>
                                                                <a id="bb_dropdown_no_settle" href="#">未结算</a>
                                                            </li>
                                                            <li>
                                                                <a id="bb_dropdown_unlock" href="#">未锁定</a>
                                                            </li>
                                                            <li>
                                                                <a id="bb_dropdown_no_plate" href="#">未封盘</a>
                                                            </li>
                                                            <li class="divider"></li>
                                                            <li>
                                                                <a id="bb_dropdown_abnormal" href="#">异常赛事</a>
                                                            </li>
                                                        </ul>
                                                    </label>
                                                </span><!-- /span -->
                                ...
                                <div class="table-responsive">
                                    <table id="bb-table" class="table1 table-striped table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>类型</th>
                        ...
                        <!-- bb edit/.modal-dialog -->
                        <div id="modal_bb_edit" class="modal fade" tabindex="-1">
                        ...
                        <div id="modal_bb_odds" class="modal fade" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header no-padding">
                                        <div class="table-header">
                                    ...
                                    <div class="widget-box">
                                        ...
                                        <div class="widget-body">
                                            <div class="widget-main">
                                                ...
                                                <div class="clearfix" id="odds_modal_op_clearfix">
                                                    <div class="grid2">
                                                        <p class="center">主胜</p>
                        ...
                        <!-- bb odds history/.modal-dialog -->
                        <div id="modal_bb_odds_history" class="modal fade" tabindex="-1">
                        ...
                        </div><!-- bb odds history/.modal-dialog -->
                        <!-- PAGE CONTENT ENDS -->
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.page-content -->
